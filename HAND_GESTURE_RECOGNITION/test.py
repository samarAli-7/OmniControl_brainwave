...
USE_AI_AGENTS = False 
ONDEMAND_API_KEY = "v9vTYShwubkL0nX5Hkj1WaeIXQjAuXu5"
ONDEMAND_URL = "https://api.on-demand.io/chat/run"

# Specialized Reasoning Modules
GESTURE_AGENT_ID = "696acde1c7d6dfdf7e337e5a" 
BIOSYNC_AGENT_ID  = "696adbfdb2795e4f7116f7c0"
SAFETY_AGENT_ID   = "696ad398ac9b040cc2f755c5" 
REHAB_AGENT_ID    = "696ae032c7d6dfdf7e337e77"         
ASL_AGENT_ID      = "696ae17fc7d6dfdf7e337e78"       
GUIDE_SYNC_ID = "696ae249ac9b040cc2f755d6"
...
# Added (1, 1, 0, 0, 0) for Speech-to-Text
GESTURE_MAP = {
...
def get_stable_signature(lms):
    ...
    # Thumb Logic: Distance to Pinky MCP
...
# =========================
def speech_worker():
    """Background thread that waits for the gesture event to record."""
    while True:
        mic_active_event.wait() # Wait until L-shape is detected
...
if __name__ == "__main__":
    app = GestureGUI()
    # Start detection and speech workers
